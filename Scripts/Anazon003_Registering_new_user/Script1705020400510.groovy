...
WebUI.setText(findTestObject('Object Repository/Page_Amazon Registration/input_email'), 'mangalisai433@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Amazon Registration/input_password'), '5PYKeXS5yY3DUATn3smwSw==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Amazon Registration/input_passwordCheck'), '5PYKeXS5yY3DUATn3smwSw==')

WebUI.click(findTestObject('Object Repository/Page_Amazon Registration/inputcontinue'))
